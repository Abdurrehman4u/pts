        ...
        <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler"
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="nav navbar-nav gap-5 ">
                    ...
                    <li class="nav-item"><a class="nav-link nav-items iactive" href="./Applicationstats.php">APPLICATION
                            STATUS</a></li>
    ...
    <div class="container justify-content-center align-items-center mt-5 mb-5 px-xl-5">
        <div class="row">
            <div class="col-md-7 col-sm-12">
                ...
                <div class="container customgrey py-4 mb-2"><a class="text-decoration-none text-black" href="#">
                        ...
                        <a href="./statusDownload.html" class="btn btn-primary">View Downloads </a>
                    </a>
                </div>
                <div class="container customgrey py-4 mb-2"><a class="text-decoration-none text-black" href="#">
                ...
                <Button href="./statusDownload.html" class="btn btn-primary mt-3 container-fluid" onclick="loadmorecontent()">Load More
                    Projects</Button>
            </div>
