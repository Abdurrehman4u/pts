...
<body>
                    ...
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            ...
                            <form id="myForm" action="./PHP/add.php" method="post">
                                ...
                                <div><button id="submitbtn" class="btn btn-primary d-block w-100" type="submit" value="submit" onclick="submitform()" disabled>Send </button></div>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    function submitForm() {
        // You can add any additional logic before submitting the form
