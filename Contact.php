        ...
        <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler"
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="nav navbar-nav gap-5 ">
                    ...
                    <li class="nav-item"><a class="nav-link nav-items iactive" href="./Contact.php">CONTACT US</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col">
                    <iframe allowfullscreen frameborder="0"
                        src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCYTUqbyjsZBCC48fUZfhfPGo0KveDaVnY&amp;q=3rd+Floor%2C+Adeel+Plaza%2C+Fazal-e-Haq+Road%2C+Block+H+G+7%2F2+Blue+Area%2C+Islamabad%2C+Islamabad+Capital+Territory+44000%2C+Pakistan&amp;zoom=11"
